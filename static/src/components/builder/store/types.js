...
export const GET_TEXT_TAGGING_2_PROPS = 'textTagging2/PROPS';
export const GET_TEXT_TAGGING_2_FORM_VALID = 'textTagging2/FORM_VALID';
export const GET_TEXT_TAGGING_2_ERRORS = 'textTagging2/GET_TEXT_TAGGING_2_ERRORS';
...
export const MUTATE_CLEAR_TEXT_TAGGING_2_FORM = 'textTagging2/MUTATE_CLEAR_TEXT_TAGGING_2_FORM';
export const MUTATE_TEXT_TAGGING_2_ANSWER_FIELD = 'textTagging2/MUTATE_TEXT_TAGGING_2_ANSWER_FIELD';
export const MUTATE_TEXT_TAGGING_2_LABEL_ADDED = 'textTagging2/MUTATE_TEXT_TAGGING_2_LABEL_ADDED';
export const MUTATE_TEXT_TAGGING_2_LABEL = 'textTagging2/MUTATE_TEXT_TAGGING_2_LABEL';
export const MUTATE_TEXT_TAGGING_2_READONLY = 'textTagging2/MUTATE_TEXT_TAGGING_2_READONLY';
export const MUTATE_TEXT_TAGGING_2_DELETE_TAG = 'textTagging2/MUTATE_TEXT_TAGGING_2_DELETE_TAG';
export const MUTATE_TEXT_TAGGING_2_ADD_TAG = 'textTagging2/MUTATE_TEXT_TAGGING_2_ADD_TAG';
export const MUTATE_TEXT_TAGGING_2_TEXT = 'textTagging2/MUTATE_TEXT_TAGGING_2_TEXT';
export const MUTATE_TEXT_TAGGING_2_DELETE_ENTITY = 'textTagging2/MUTATE_TEXT_TAGGING_2_DELETE_ENTITY';
export const MUTATE_TEXT_TAGGING_2_ADD_ENTITY = 'textTagging2/MUTATE_TEXT_TAGGING_2_ADD_ENTITY';
export const MUTATE_TEXT_TAGGING_2_SOURCE_TYPE = 'textTagging2/MUTATE_TEXT_TAGGING_2_SOURCE_TYPE';
export const MUTATE_TEXT_TAGGING_2_ENTITY_SOURCE = 'textTagging2/MUTATE_TEXT_TAGGING_2_ENTITY_SOURCE';
export const MUTATE_TEXT_TAGGING_2_USE_STATIC_IN_PREVIEW = 'textTagging2/MUTATE_TEXT_TAGGING_2_USE_STATIC_IN_PREVIEW';
export const MUTATE_TEXT_TAGGING_2_CONFIDENCE_THRESHOLD = 'textTagging2/MUTATE_TEXT_TAGGING_2_CONFIDENCE_THRESHOLD';
